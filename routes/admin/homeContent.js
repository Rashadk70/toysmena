...
router.get('/home-content', protect, async (req, res) => {
  try {
...
router.post('/featured-categories', protect, admin, async (req, res) => {
  try {
...
router.put('/featured-categories/:id', protect, admin, async (req, res) => {
  try {
...
router.delete('/featured-categories/:id', protect, admin, async (req, res) => {
  try {
...
router.put('/promotions/:id', protect, admin, async (req, res) => {
  try {
...
router.delete('/promotions/:id', protect, admin, async (req, res) => {
  try {
...
router.post('/custom-sections', protect, admin, async (req, res) => {
  try {
...
router.put('/custom-sections/:id', protect, admin, async (req, res) => {
  try {
...
router.delete('/custom-sections/:id', protect, admin, async (req, res) => {
  try {
